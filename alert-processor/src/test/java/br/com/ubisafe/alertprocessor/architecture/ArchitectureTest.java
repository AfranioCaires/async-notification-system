package br.com.ubisafe.alertprocessor.architecture;
...
@AnalyzeClasses(packages = "br.com.ubisafe.alertprocessor", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {

    private static final String DOMAIN = "br.com.ubisafe.alertprocessor.domain..";
    private static final String APPLICATION = "br.com.ubisafe.alertprocessor.application..";
    private static final String INFRASTRUCTURE = "br.com.ubisafe.alertprocessor.infrastructure..";
    private static final String PRESENTATION = "br.com.ubisafe.alertprocessor.presentation..";
    ...
    @ArchTest
    static final ArchRule deliveryStrategiesLiveInInfrastructure = classes()
            .that().implement("br.com.ubisafe.alertprocessor.application.port.AlertDeliveryStrategy")
            .should().resideInAPackage("br.com.ubisafe.alertprocessor.infrastructure.delivery");
